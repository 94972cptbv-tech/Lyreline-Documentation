...
advanced composition workspace, you can continue the authored procedure in
Studio and return the supported project to Lyreline. Authored sections reopen as
Procedure steps, with supported images, presentation edits, numbered callouts,
labels, and instruction links preserved.
